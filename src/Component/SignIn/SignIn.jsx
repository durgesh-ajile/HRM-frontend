    ...
    return (
        <div className={styles.container}>
            <div className={styles.innerBox}>
                ...
                <label htmlFor="floatingInput" style={{ paddingBottom: '10px' }}>Username</label>
                <div className="form-floating mb-3">
                    <div className="input-group  input-group-lg  name">
                        <span className="input-group-text" id="basic-addon1"><BsPersonCircle />
                        </span>
                        <input type="username" style={{ width: '82%' }} className="form-control" id="floatingInput" placeholder="Enter your name " onChange={(event) => setValue((prev) => ({ ...prev, name: event.target.value }))} />
                    </div>
                </div>

                <label htmlFor="floatingInput" style={{ paddingBottom: '10px' }}>Password</label>
                <div className="form-floating mb-3">
                    <div className="input-group  input-group-lg  ">
                        <span className="input-group-text" id="basic-addon1"><AiFillLock />
                        </span>
                        <input type="password" style={{ width: '82%' }} className="form-control" id="floatingInput" placeholder="Password" onChange={(event) => setValue((prev) => ({ ...prev, pass: event.target.value }))} />
                    </div>
                </div>
                    ...
                    <div className='col-4' style={{ padding: '20px' }}>
                        <span>
                            <div className="form-check">
                                <input className="form-check-input" type="checkbox" value="" id="flexRadioDefault2" checked />
